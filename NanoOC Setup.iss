...
; Generated by Chris Woodhouse on 4/2/2021 (UTC)
;
[Setup]
AppID={{a6e57678-be01-480c-bba2-a09bcf743815}
AppName=ASCOM NanoOC ObservingConditions Driver
AppVerName=ASCOM NanoOC ObservingConditions Driver 2.5
AppVersion=1.3
...
OutputDir="."
OutputBaseFilename="NanoOC Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\ObservingConditions\NanoOC"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\ObservingConditions\NanoOC"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "E:\Visual Studio\Project files\Gizmo\NanoEnvironment\bin\Release\ASCOM.NanoOC.ObservingConditions.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "E:\Visual Studio\Project files\Gizmo\NanoEnvironment\ReadMe.htm"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.NanoOC.ObservingConditions.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.NanoOC.ObservingConditions.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.NanoOC.ObservingConditions.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.NanoOC.ObservingConditions.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.NanoOC.ObservingConditions.dll"""; Flags: runhidden 64bit; Check: IsWin64
